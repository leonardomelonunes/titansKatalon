...
WebUI.setText(findTestObject('Object Repository/Page_Neogrid - Login Incorrect Password/input_Endereo de Email_Username or email address'), 
    'junior.sturm@ndd.com.br')

WebUI.setEncryptedText(findTestObject('Object Repository/Page_Neogrid - Login Incorrect Password/input_Esqueceu a senha_Senha'), 
    'D3DFnBrUPGw=')
